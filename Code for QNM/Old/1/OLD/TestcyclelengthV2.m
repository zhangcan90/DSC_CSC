                ...
                if od(i,j,T)>0
                    ...
                    if a>1
                        if p(1,m+1)<p(2,m+1)
                            ...
                            if out(i,p(1,2),T+tc(i,p(1,2),T))>capacity(i,p(1,2))
                                diff=out(i,p(1,2),T+tc(i,p(1,2),T))-capacity(i,p(1,2));
                                out(i,p(1,2),T+tc(i,p(1,2),T)+1)=out(i,p(1,2),T+tc(i,p(1,2),T)+1)+diff;
                                out(i,p(1,2),T+tc(i,p(1,2),T))=capacity(i,p(1,2)); %outflow rate can be changed
                            ...
                            if out(i,p(2,2),T+tc(i,p(2,2),T))>capacity(i,p(2,2))
                                diff=out(i,p(2,2),T+tc(i,p(2,2),T))-capacity(i,p(2,2));
                                out(i,p(2,2),T+tc(i,p(2,2),T)+1)=out(i,p(2,2),T+tc(i,p(2,2),T)+1)+diff;
                                out(i,p(2,2),T+tc(i,p(2,2),T))=capacity(i,p(2,2)); %outflow rate can be changed
